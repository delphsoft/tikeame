...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative overflow-hidden px-5 py-16 md:px-12 md:py-[110px] md:pb-[70px]">
        <Image
          src="/evento-hero.avif"
          alt=""
          fill
          priority
          className="hero-zoom object-cover blur-[6px] saturate-125"
        />
        <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(43,29,74,0.92)_0%,rgba(43,29,74,0.78)_45%,rgba(43,29,74,0.55)_100%)]" />
        ...
        <div className="mx-auto max-w-[1240px]">
          ...
          <div className="relative mt-16 grid gap-10 md:grid-cols-3 md:gap-0">
            ...
            {steps.map((s) => (
              <div
                key={s.n}
                className={`relative z-10 flex flex-col items-center px-[22px] ${s.rot}`}
              >
                <div
      ...
      <section id="fidelizacion" className="bg-ink px-5 py-16 md:px-12 md:py-[90px]">
        <div className="mx-auto max-w-[1240px]">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {rrpp.map((card) => (
              <div key={card.title} className="rounded bg-plum px-6 py-7">
      ...
      <section className="bg-coral px-5 py-20 text-center md:px-12 md:py-[100px]">
        <h2 className="mx-auto max-w-[680px] font-display text-4xl uppercase leading-[1.3] text-white md:text-[44px]">
          El tikeame que te lleva a la fiesta.
        </h2>
        <p className="mx-auto mt-[18px] max-w-[480px] text-[17px] font-semibold leading-normal text-[#FFE4DF]">
          Sumá tu evento y mostrale a tu público cuánto está pagando, de verdad.
        </p>
        <a
          href="mailto:hola@tikeame.com.ar?subject=Quiero%20sumar%20mi%20evento%20a%20Tikeame"
          className="mt-[30px] inline-block rounded bg-ink px-[34px] py-4 text-[15px] font-extrabold text-cream"
        >
          Sumar mi evento
        </a>
      </section>
